import 'package:capstone_airbnb/Components/display_place.dart';
import 'package:capstone_airbnb/Components/map_with_custom_info_windows.dart';
import 'package:capstone_airbnb/Components/search_bar_and_filter.dart';
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
            ...
            SearchBarAndFilter(),
            //let's fetch list of categories from firebase
