  ...
  Future<void> removeFromWishlist(BuildContext context, String docId) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            lang.t('Removed from wishlist', 'Đã xóa khỏi yêu thích'),
          ),
        ),
      );
    } catch (e) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('${lang.t('Remove failed', 'Xóa thất bại')}: $e'),
        ),
      );
    }
  }
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
            return Center(
              child: Text(
                lang.t('No wishlist yet', 'Chưa có mục yêu thích'),
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => PlaceDetailScreen(place: data),
                  ),
                ),
                child: Container(
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            child: GestureDetector(
                              onTap: () => removeFromWishlist(context, doc.id),
                              child: const Icon(
                                Icons.favorite,
                                color: Colors.red,
                                size: 32,
